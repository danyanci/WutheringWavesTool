...
public partial class ImageExBase
{
    ...
    /// </summary>
    public static readonly DependencyProperty DecodePixelTypeProperty = DependencyProperty.Register(
        nameof(DecodePixelType),
        typeof(int),
        typeof(ImageExBase),
        new PropertyMetadata(DecodePixelType.Physical)
    );
    ...
    /// </summary>
    public static readonly DependencyProperty IsCacheEnabledProperty = DependencyProperty.Register(
    ...
    public static readonly DependencyProperty EnableLazyLoadingProperty =
        DependencyProperty.Register(
            ...
            typeof(bool),
            typeof(ImageExBase),
            new PropertyMetadata(false, EnableLazyLoadingChanged)
        );
    ...
    public static readonly DependencyProperty LazyLoadingThresholdProperty =
        DependencyProperty.Register(
            ...
            typeof(double),
            typeof(ImageExBase),
            new PropertyMetadata(default(double), LazyLoadingThresholdChanged)
        );
    ...
    private static void EnableLazyLoadingChanged(
        DependencyObject d,
    ...
    private static void LazyLoadingThresholdChanged(
        DependencyObject d,
        DependencyPropertyChangedEventArgs e
    )
    {
