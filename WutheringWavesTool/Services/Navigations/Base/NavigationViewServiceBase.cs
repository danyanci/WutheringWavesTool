...
using WutheringWavesTool.Controls.Propertys;
...
namespace WutheringWavesTool.Services.Navigations.Base
{
    public class NavigationViewServiceBase : INavigationViewService
    {
        ...
        public NavigationViewServiceBase(
        ...
        {
            if (
                menuItem.GetValue(NavigationItemClickHelper.NavigationKeyProperty) is string pageKey
            )
            {
